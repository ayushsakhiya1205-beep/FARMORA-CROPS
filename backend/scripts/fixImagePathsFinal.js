...
const productImageMap = {
  ...
  'Almonds (Badam)': '/image/dryfruits/badam.jpg',
  'Cashews (Kaju)': '/image/dryfruits/kaju.jpg',
  'Raisins (Kishmis)': '/image/dryfruits/kismis.jpg',
  'Figs (Anjeer)': '/image/dryfruits/anjeer.jpg',
  'Dates (Khajoor)': '/image/dryfruits/khajoor.jpg',
  'Pistachios (Pista)': '/image/dryfruits/pista.png',
  'Apricots (Aprikot)': '/image/dryfruits/aprikot.png',
  'Carrot (Akharot)': '/image/dryfruits/akharot.png',
  'Black Raisins (Black Kishmis)': '/image/dryfruits/black kishmis.png'
};
